<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WFVendedor.aspx.cs" Inherits="CapaWeb.WFVenedor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h3>Mantenimiento de la tabla vendedor gaaa</h3>
    <p>CodVendedor:<asp:TextBox runat="server" ID="txtCodVendedor"></asp:TextBox></p>
    ...
    <p>Password:<asp:TextBox runat="server" ID="txtContrasena"></asp:TextBox></p>
    <p>
